...
export function Card({ className, ...props }: CardProps) {
    return (
        <div
            className={cn(
                "overflow-hidden rounded-lg border border-palette-300 text-brandtext-300",
                className
            )}
            {...props}
        />
...
Card.Footer = function CardFooter({ className, ...props }: CardFooterProps) {
    return (
        <div
            className={cn(
                "border-t border-palette-300 bg-palette-400 px-6 py-4",
                className
            )}
            {...props}
        />
...
Card.Skeleton = function CardSeleton() {
    return (
        <Card>
            ...
            <Card.Footer>
                <Skeleton className="h-8 w-[120px] bg-palette-300" />
            </Card.Footer>
        </Card>
    )
}
